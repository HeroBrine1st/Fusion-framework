...
import ru.herobrine1st.fusion.api.command.option.FusionCommandWithSubcommands;
...
public final class WithSubcommandsBuilder extends BaseCommandBuilder<WithSubcommandsBuilder, FusionSubcommand> {
    ...
    public FusionCommand<FusionSubcommand> build() {
        return new FusionCommandWithSubcommands(name, description, options, permissionHandler);
    }
}
