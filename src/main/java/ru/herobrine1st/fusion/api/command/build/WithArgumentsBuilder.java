...
import ru.herobrine1st.fusion.api.command.option.FusionCommandWithArguments;
...
public final class WithArgumentsBuilder extends BaseCommandBuilder<WithArgumentsBuilder, ParserElement<?, ?>> {
    ...
    public FusionCommand<ParserElement<?, ?>> build() {
        return new FusionCommandWithArguments(name, description, executor, options, permissionHandler);
    }
}
