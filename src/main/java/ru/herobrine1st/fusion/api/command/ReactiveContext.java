...
public interface ReactiveContext {
     ...
     * <br>
     * <b>You should run reactive methods unconditionally</b>, otherwise you get exceptions because {@code <T>} is used in <b>unsafe cast</b>
     *
     ...
     */
    <T> T useComponent(T initialState, BiFunction<String, T, T> onComponentInteraction, String... componentIds);

    <T> State<T> useState(T initialState);
